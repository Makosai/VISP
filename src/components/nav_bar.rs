...
pub(crate) fn Profile() -> Element {
    rsx! {
        div {
            ...
            p { class: "font-bold", "Kristopher Ali" }
            p { class: "font-thin text-sm", "Software Developer" }
        }
    }
}
...
pub(crate) fn Headline() -> Element {
    rsx! {
        div {
            p { class: "font-black", "VISP" }
            p { class: "font-thin text-sm text-v-gray", "Video. Image. Sound. Post." }
        }
    }
}
...
pub(crate) fn NavBar() -> Element {
    ...
    rsx! {
        div { class: "h-full",
            div { class: "sidebar",
                div { class: "font-bold text-2xl flex gap-2 justify-center items-center",
                    img {
                        class: "rounded-full",
                        width: "64",
                        height: "32",
                ...
                nav {
                    ul { class: "flex flex-col gap-2 justify-center",
                        ...
                        li { class: if selected().eq("Video") { "selected" } else { "" },
                            Link {
                                to: Route::Video {},
                        ...
                        li { class: if selected().eq("Image") { "selected" } else { "" },
                            Link {
                                to: Route::Image {},
                        ...
                        li { class: if selected().eq("Sound") { "selected" } else { "" },
                            Link {
                                to: Route::Sound {},
                        ...
                        li { class: if selected().eq("Post") { "selected" } else { "" },
                            Link {
                                to: Route::Post {},
